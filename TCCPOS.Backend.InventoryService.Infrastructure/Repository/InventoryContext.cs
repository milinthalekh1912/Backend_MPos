...
namespace TCCPOS.Backend.InventoryService.Infrastructure.Repository
{
    public partial class InventoryContext : DbContext
    {
        ...
        public virtual DbSet<employeeelogin> employeeelogin { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseMySql("server=127.0.0.1;port=3306;userid=root;password=@Puifaii2544;database=sql12624485", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.33-mysql"));
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<employeeelogin>(entity =>
            {
