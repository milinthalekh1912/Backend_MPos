...
using System.Net;
using System.Text;
using TCCPOS.Backend.ReportService.Application;
using TCCPOS.Backend.ReportService.Application.Exceptions;
using TCCPOS.Backend.ReportService.Application.Feature;
using TCCPOS.Backend.ReportService.Infrastructure;
...
app.UseExceptionHandler(x =>
{
    x.Run(async context =>
    {
        ...
        if (ex != null)
        {
            ...
            var ssex = ex.Error as ReportServiceException;
            if (ssex != null)
            {
            ...
            {
                var errres = new FailedResult();
                errres.ErrorCode = "RE000"; // unknow excpetion
