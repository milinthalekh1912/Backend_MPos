...
app.UseExceptionHandler(x =>
{
    x.Run(async context =>
    {
        ...
        if (ex != null)
        {
            ...
            var ssex = ex.Error as InventoryServiceException;
            if (ssex != null)
            {
            ...
            {
                var errres = new FailedResult();
                errres.ErrorCode = "IE000"; // unknow excpetion
