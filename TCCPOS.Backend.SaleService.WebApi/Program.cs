...
using System.Net;
using System.Text;
using TCCPOS.Backend.SaleService.Application;
using TCCPOS.Backend.SaleService.Application.Exceptions;
using TCCPOS.Backend.SaleService.Application.Feature;
using TCCPOS.Backend.SaleService.Infrastructure;
...
app.UseExceptionHandler(x =>
{
    x.Run(async context =>
    {
        ...
        if (ex != null)
        {
            ...
            var ssex = ex.Error as SaleServiceException;
            if (ssex != null)
            {
            ...
            {
                var errres = new FailedResult();
                errres.ErrorCode = "SA000"; // unknow excpetion
